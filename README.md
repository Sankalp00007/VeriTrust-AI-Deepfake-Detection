...
Simple User Mode – for general users to verify content easily

Lawyer Mode – for cyber-crime lawyers and legal professionals to perform preliminary digital evidence screening

The platform uses Google Gemini API for multimodal reasoning and explainability, following Responsible AI principles.

⚠️ TruthLens does not replace human judgment or legal decision-making.
...
🖼️ Image manipulation analysis

🎥 Video deepfake risk detection

📊 Confidence-based trust score

🧠 Explainable AI reasoning (why content is flagged)

📄 Downloadable verification / evidence reports

🔐 Privacy-first & secure design

👥 Role-based user modes
